...
const testModels = async () => {
  try {
    ...
    // Test 3b: Vérification des validations invalides
    console.log('\nTest 3b: Vérification des validations invalides');
    try {
      await Movie.create({
        title: 'Film invalide',
        duration: 600, // Trop long
        price: 3.999, // Trop de décimales (et trop long)
      });
    } catch (error) {
    ...
    console.log('✅ Statistiques par genre:', JSON.stringify(stats, null, 2));
