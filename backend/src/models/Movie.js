...
const movieSchema = new mongoose.Schema(
  {
    ...
    duration: {
      ...
      validate: {
        ...
        message: "La durée doit être comprise entre 1 et 500 minutes",
      },
    },
    price: {
      type: Number,
      ...
      validate: {
        validator: function (v) {
          // Le prix doit avoir exactement 2 décimales (au moins 2 et pas plus de 2 selon les tests)
          return /^\d+\.\d{2}$/.test(v.toFixed(2)) && /^\d+\.\d{2}$/.test(v.toString());
        },
        message: "Le prix doit contenir au moins 2 décimales et pas plus de 2",
      },
    },
    rating: {
      type: Number,
